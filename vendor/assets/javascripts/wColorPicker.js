...
{	
	...
	$.fn.wColorPicker.defaultSettings = {
		theme			: 'white', 		// colors - black, white, cream, red, green, blue, yellow, orange, plum
		opacity			: 1,			// opacity level
		initColor		: '#3366FF',	// initial colour to set palette to
		...
		mode			: 'hover',		// flat mode inserts the palette to container, other modes insert button into container - hover, click
		buttonSize		: 20,			// size of button if mode is ohter than flat
		effect			: 'slide',		// none/slide/fade
		showSpeed		: 400,			// time to run the effects on show
		hideSpeed		: 50			// time to run the effects on hide
	};
