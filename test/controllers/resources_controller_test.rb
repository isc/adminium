...
class ResourcesControllerTest < ActionController::TestCase
  ...
  def test_advanced_search_operators
    ...
    add_filter_to_test 'integer_in', ['Michel', nil], [{"column" => 'age', "type" => "integer", "operator"=>"IN", "operand" => "17, 19"}]

    add_filter_to_test 'string_like', ['Michel'], [{"column" => 'pseudo', "type" => "string", "operator"=>"like", "operand" => "iche"}]
    add_filter_to_test 'string_starts_with', ['Martin', 'Michel'], [{"column" => 'pseudo', "type" => "string", "operator"=>"starts_with", "operand" => "M"}]
    add_filter_to_test 'string_ends_with', ['Martin'], [{"column" => 'pseudo', "type" => "string", "operator"=>"ends_with", "operand" => "tin"}]
    add_filter_to_test 'string_not_like', ['Loulou', 'Martin'], [{"column" => 'pseudo', "type" => "string", "operator"=>"not_like", "operand" => "iche"}]
