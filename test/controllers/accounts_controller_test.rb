...
class AccountsControllerTest < ActionController::TestCase
  def test_auto_provision_the_addon
    ...
    account = create :account, heroku_id: "app#{data['id']}@heroku.com", db_url: nil # should be done by heroku during the create request
    post :create, params: {name: 'test-addon', app_id: data['id'], plan: 'petproject'}
