...
class Heroku::ResourcesControllerTest < ActionController::TestCase
  ...
  def test_update_deleted_account
    id = 'app37@heroku.com'
    account = create :account, heroku_uuid: id, plan: 'deleted', deleted_at: 3.days.ago
  ...
  def create_account id
    ...
    post :create, params: {resource: {heroku_id: id, plan: 'startup', callback_url: "blablal/#{id}", bad_key: 'lol'}}
